...
function createConfiguration() {
    return {
        ...
        sources: {
            'Factory.sol': {
                content: fs.readFileSync(path.resolve(__dirname, 'contract', 'Factory.sol'), 'utf8')
            },/*
...
function getImports(dependency) {
    ...
    switch (dependency) {
        case 'Voting.sol':
            return {contents: fs.readFileSync(path.resolve(__dirname, 'contract', 'Voting.sol'), 'utf8')};
        case 'RegisterAsVoter.sol':
            return {contents: fs.readFileSync(path.resolve(__dirname, 'contract', 'RegisterAsVoter.sol'), 'utf8')};
        default:
